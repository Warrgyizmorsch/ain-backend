                   ...
                   @if($order->user != '')
                    ...
                    <div class="row g-9 mb-8 text-start order-container" data-order-id="{{$order->user->id}}">
                        <div class="col-md-2 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="" value="{{$order->user->countrycode}}" name="country_code">
                        </div>
                        <div class="col-md-3 fv-row text-start">
                            <label class="fs-6 fw-bold mb-2">Mobile Number</label>
                            <input type="text" class="form-control form-control-solid" placeholder="" value="{{$order->user->mobile_no}}" name="mobile">
                        </div>
