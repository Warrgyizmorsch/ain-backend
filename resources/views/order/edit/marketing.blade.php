                ...
                @method('PUT')
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-bold fs-5">
                            ...
                            <a href="#" class="fw-bolder link-primary"> <span class="label label-primary" style="background-color: 
                                    ...
                                    @elseif($order->projectstatus == 'Hold(writer query)') #f1416c;
                   ...
                   @if($order->user != '')
                    ...
                    <div class="row g-9 mb-8 text-start">
                        ...
                        <input type="text" readonly  class="form-control form-control-solid" placeholder="" value="{{$order->user->name}}" name="user_name">
                           
                        </div>
                        <div class="col-md-6 fv-row text-start">
                            <label class=" fs-6 fw-bold mb-2">Email</label>
                            <input type="text" readonly class="form-control form-control-solid" placeholder="" value="{{ $displayEmail }}" name="email">
                        </div>
                    </div>
                    ...
                    <div class="row g-9 mb-8 text-start order-container" data-order-id="{{$order->user->id}}">
                        <div class="col-md-2 fv-row">
                            ...
                            <input type="text" readonly class="form-control form-control-solid" placeholder="" value="{{ $displayCountry }}" name="country_code">
                        </div>
                        <div class="col-md-3 fv-row text-start">
                            <label class="fs-6 fw-bold mb-2">Mobile Number</label>
                            <input type="text" readonly class="form-control form-control-solid" placeholder="" value="{{ $displayMobile }}" name="mobile">
                        </div>
                        @if($isSuperAdmin)
                        ...
                        <div class="col-md-2 fv-row">
                            <label class="fs-6 fw-bold mb-2">Country Code</label>
                            <input type="text" @if(!$isSuperAdmin) readonly @endif class="form-control form-control-solid" placeholder="" value="{{ $displayCountry2 }}" name="country_code2">
                        </div>
                        <div class="col-md-3 fv-row text-start">
                            <label class="fs-6 fw-bold mb-2">Mobile Number-2</label>
                            <input type="text" @if(!$isSuperAdmin) readonly @endif class="form-control form-control-solid" placeholder="" value="{{ $displayMobile2 }}" name="mobile2">
                        </div>
                    </div>
                    <script>
