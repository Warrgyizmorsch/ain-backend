                    ...
                    <form action="">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3 fv-row fv-plugins-icon-container">
                                ...
                                <a href="{{ url('/smart-leads') }}" class="btn btn-sm btn-danger">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Smart Assignment</small>
                </div>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Convert Lead 
                                                                    {{-- (Lead ID: <span class="text-success">LT{{ $lead->id }}</span>) --}}
                                                                </h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body text-start" style="white-space: normal;">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="source_url" class="form-control" placeholder="https://smartassignmenthelp.de/">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    function openLeadModal(mode, leadData = null) {
        ...
        if (mode === 'create') {
            ...
            // Clear all fields
            form.reset();
            // Set default source URL for Smart Assignment
            form.querySelector('[name="source_url"]').value = 'https://smartassignmenthelp.de/';
