            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 12px 35px rgba(16,24,40,.09);">
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td style="padding:30px 36px;">
                                    ...
                                    <div style="margin-top:8px;color:#dbe4ff;font-size:14px;line-height:1.6;">A secure password reset was requested for your account.</div>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:34px 36px 12px;">
                        ...
                        <p style="margin:0;color:#475467;font-size:15px;line-height:1.75;">We received a request to reset the password for <strong style="color:#182230;">{{ $email }}</strong>. Tap the button below to continue securely on our website.</p>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="padding:24px 36px;">
                        <a href="{{ $resetUrl }}" style="display:inline-block;background:#4f46e5;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;padding:15px 28px;border-radius:10px;box-shadow:0 8px 18px rgba(79,70,229,.24);">Reset Password</a>
                    </td>
                </tr>
                <tr>
